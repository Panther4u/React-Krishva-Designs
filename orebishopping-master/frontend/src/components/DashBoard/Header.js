...
function HeaderNav() {
  return (
    <>
        <div className="h-16 lg:flex-end w-full border-b border-gray-200 dark:border-gray-800 ">
          ...
          <div className=" flex items-center justify-end h-full space-x-5 px-3">
            <button className="h-8 px-3 rounded-md shadow text-white bg-blue-500">Log Out</button>
